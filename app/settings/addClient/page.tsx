...
export default function AddInvoice({
  ...
  const [imageUrl, setImageUrl] = useState<string | null>("/images/default.png");
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const bank = {
        ...
        bank_logo_url: imageUrl || "/images/default.png", // Update the logo URL if a new one is uploaded
      };
